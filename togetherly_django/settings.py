"""
Django settings for togetherly_django project.
...
SECRET_KEY = 'django-insecure-#-=82rqc7y4dkio96^m=rrsfy#s1ghv4mbi7)mx-k_ff(lpalc'
...
ROOT_URLCONF = 'togetherly_django.urls'
...
WSGI_APPLICATION = 'togetherly_django.wsgi.application'
...
# Add these settings for Django REST Framework
REST_FRAMEWORK = {
